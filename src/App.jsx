...
import ProductDetails from './components/product/ProductDetails';
import PaymentReceipts from './pages/PaymentReceipt';
import SalesReport from './pages/SalesReport';
import AgentSummary from './pages/AgentSummary';
import DebtPage from './pages/DebtPage';
import { getAllExportReceipts, getAllImportReceipts, getAllProducts, getAllUnits } from './services/receiptService';
    ...
    const fetchInitialData = async () => {
      try {
        ...
        setReceipts({
          ...
          export: exportReceiptsResponse.data || [],
        });
      } catch (err) {
        toast.error('Lỗi khi tải dữ liệu ban đầu. Vui lòng thử lại!');
      } finally {
        ...
        <BrowserRouter>
          <Routes>
            <Route path="/" element={<MainLayout />}>
              ...
              <Route path="/payments" element={<PaymentReceipts />} />
              ...
              <Route path="/debt-report" element={<DebtPage />} />
